...
export const notaKuasaTigaContent = {
  ...
  insight: {
    ...
    body:
      "Kau baru bina SATU lapisan: 3 × 3 = 9 kiub kecil. Tapi kotak KIUB tu ada TINGGI juga — dan sebab " +
      "semua sisi kiub SAMA PANJANG (3cm), kita perlukan 3 lapisan macam ni, bertindan antara satu sama " +
      "lain. Jumlah kiub kecil = 9 × 3 = 27. Operasi \"darab nombor dengan dirinya sendiri, TIGA kali\" ni " +
      "dipanggil KUASA TIGA. Ditulis sebagai 3³ (baca: \"3 kuasa tiga\"), bermaksud 3 × 3 × 3 = 27. Abang " +
      "Zul perlukan 27 kiub ais kecil.",
  },
  ...
  formula: {
    ...
    expression: "n³ = n × n × n",
    body:
      "PUNCA KUASA TIGA (simbol ∛) ialah operasi SEBALIKNYA bagi kuasa tiga — ia cari BALIK panjang sisi " +
      "kiub apabila kita tahu jumlah isipadu (bilangan kiub kecil). Cth: ∛27 = 3, sebab 3 × 3 × 3 = 27. " +
      "Nombor seperti 1, 8, 27, 64, 125, 216... dipanggil NOMBOR KUASA TIGA SEMPURNA (perfect cubes) sebab " +
      "punca kuasa tiganya ialah nombor bulat yang kemas.",
  },
